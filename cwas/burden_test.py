...
def apply_region_mapping(df: pd.DataFrame):
    ...
    noncoding_region = ['NoncodingRegion', 'IntronRegion', 'lincRnaRegion',
                        ...
                        '3PrimeUTRsRegion', '5PrimeUTRsRegion', 'SpliceSiteRegion']
    ...
    region_mapping = {
        ...
        'is_splice': lambda x: (x['gencode'] == 'SpliceSiteRegion').astype(int),
        ...
        'is_UTR': lambda x: ((x['gencode'] == '3PrimeUTRsRegion') | (x['gencode'] == '5PrimeUTRsRegion')).astype(int),
