...
* `CWAS-Plus: Estimating category-wide association of rare noncoding variation from whole-genome sequencing data with cell-type-specific functional data <https://pubmed.ncbi.nlm.nih.gov/38966948/>`_ (Kim et al., 2024)
